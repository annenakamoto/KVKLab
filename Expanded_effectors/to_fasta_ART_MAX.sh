...
while read GENOME; do
    ...
    bedtools getfasta -name -fi /global/scratch/users/annen/GENOME_TREE/hq_genomes/${GENOME}.fasta -fo FASTA/${GENOME}.ART.fasta -bed tmp.${GENOME}.ART.bed
    ...
    bedtools getfasta -name -fi /global/scratch/users/annen/GENOME_TREE/hq_genomes/${GENOME}.fasta -fo FASTA/${GENOME}.MAX.fasta -bed tmp.${GENOME}.MAX.bed
