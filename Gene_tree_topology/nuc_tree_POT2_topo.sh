...
while read OG; do
    ...
    cat RAxML_bestTree.RAxML.${OG} | python /global/scratch/users/annen/KVKLab/Gene_tree_topology/is_nuc_pot2_topo.py ${OG} >> treeKO_analysis/POT2_topo_NUC_tree.DATA.txt
    conda deactivate
