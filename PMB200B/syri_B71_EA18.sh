...
~/syri/syri/bin/syri -c EA18_v_B71_full.filtered.coords -d EA18_v_B71_full.filtered.delta -r EA18_chrom_only.fasta -q B71_chrom_only.fasta --nc 5 --all
...
plotsr --sr syri.out --genomes genomes_list -o EA18_v_B71.png
