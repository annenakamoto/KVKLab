...
python3.7 /global/scratch/users/annen/anaconda3/envs/BUSCO/bin/generate_plot.py -wd /global/scratch/users/annen/BUSCO_all_genomes/busco_all_out/summaries
