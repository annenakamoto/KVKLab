...
RepeatModeler -engine ncbi -pa 24 -database rmdb_$GENOME -LTRStruct -ninja_dir /global/home/users/annen/.conda/envs/RepeatModeler/bin/NINJA-0.95-cluster_only/NINJA -recoverDir /global/scratch/users/annen/
