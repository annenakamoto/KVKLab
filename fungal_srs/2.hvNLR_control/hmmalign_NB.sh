...
echo "${DOM} hmm 50% length: ${leng}"
esl-alimanip -o ${species}.${DOM}.filt.sto --lmin ${leng} ${species}.${DOM}.nogap.sto          ## remove sequences with less than ~50% of the model length
...
echo "${DOM} ${species}-specific hmm 70% length: ${leng}"
