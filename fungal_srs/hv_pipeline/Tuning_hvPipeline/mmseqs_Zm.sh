...
mmseqs linclust Zm_panPROTEOME Zm_panPROTEOME_clu tmp --cov-mode 0 -c 0.${COV} --min-seq-id 0.${MSID} --alignment-mode 3 --cluster-mode 2    # run the linear clustering algorithm on the database
