...
cat OG_CONS/OG* > OG_Consenses.fa
...
mmseqs linclust OG_Consenses OG_Consenses_clu tmp --cov-mode 0 -c 0.5 --min-seq-id 0.5    # run the linear clustering algorithm on the database
