...
#setwd("/global/scratch/users/annen/000_FUNGAL_SRS_000/Tuning_hvPipeline/OG_MAFFT")             ## check Zm initial OG mafft
#setwd("/global/scratch/users/annen/000_FUNGAL_SRS_000/MoOrthoFinder/OG_Alignments")            ## check Mo initial OG mafft
setwd("/global/scratch/users/annen/000_FUNGAL_SRS_000/Tuning_hvPipeline/REFINEMENT/FINAL_AFA")  ## check Zm final clade mafft for hv
...
assess_alignment <- function(afa) {
  ...
  ##if entropy is >1.5 for >10 position
  if (nHVsites > min_hvSites) {
    print(afa)
  }
}
